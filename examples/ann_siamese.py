...
e2e_arch = [
    ['e2e',  # e2e layer
     {'n_filters': 256,  # 32 feature maps
      'kernel_h': x_train.shape[2], 'kernel_w': x_train.shape[3]  # Sliding cross filter of size h x 1 by 1 x w
      }
     ],
    ['e2n', {'n_filters': 512, 'kernel_h': x_train.shape[2], 'kernel_w': x_train.shape[3]}],
...
hello_net = BrainNetCNN('e2e', e2e_arch)  # Create BrainNetCNN model
